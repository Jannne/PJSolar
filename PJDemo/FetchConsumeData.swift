...
class FetchConsumeData{
    ...
    func callPFObjectQueryConDaily() {
        
        
        let conData_Id = (PFUser.currentUser()!["conData_Id"] as? String) ?? ""
        
        let query = PFQuery(className: "ConsumeData")
        query.whereKey("conData_Id", equalTo: conData_Id)
    ...
    func callPFObjectQueryConWeekly(){
        let conData_Id = (PFUser.currentUser()!["conData_Id"] as? String) ?? ""
        ...
        for index in 1...count{
            ...
            var query = PFQuery(className: "ConsumeData")
            query.whereKey("conData_Id", equalTo: conData_Id)
    ...
    func callPFObjectQueryConMonthly(){
        for i in 1...30{
    ...
    func callPFObjectQueryConYearly(){
